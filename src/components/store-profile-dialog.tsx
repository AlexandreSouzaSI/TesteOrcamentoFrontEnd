...
export function StoreProfileDialog() {
    ...
    function updateManagedUserCache ({
        name,
        password,
    }: StoreProfileSchema) {
        const cached = queryClient.getQueryData<getProfileUpdateResponse>(['profile'])
            ...
            <form onSubmit={handleSubmit(handleUpdateProfile)}>
                <div className="space-y-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <Input className="col-span-3" id="password" {...register('password')}/>
                    </div>
                </div>
